/*
 * This definitions of the PIC16F84 MCU.
 *
...
__at(0x0008) __sfr EEDATA;

//__at(0x0009) __sfr EEADR;
...
__at(0x0088) __sfr EECON1;
__at(0x0088) volatile __EECON1bits_t EECON1bits;

//__at(0x0089) __sfr EECON2;

__at(0x008A) __sfr UART_TX;
__at(0x008B) __sfr UART_RX;
__at(0x0089) __sfr UART_SR;
__at(0x0089) volatile __UART_SRbits_t UART_SRbits;
