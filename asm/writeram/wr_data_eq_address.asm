...
L0  MOVLW   0xC         ; SET POINTER TO 0
    MOVWF   FSR         ; ...
L1  MOVFW   FSR
    MOVWF   INDF        ; WRITE 0 TO POINTER ADDRESS
    INCF    FSR,1       ; INC POINTER 
    BTFSS   FSR,7       ; if != 0x80 LOOP L1
    GOTO    L1          ; KEEP GOING IF POINTER != 0
    BSF     STATUS, IRP ; ...ELSE SET BANK 1
    GOTO    L0          ; ...AND START OVER.
;
    END ;;;;;;
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;    BCF     STATUS, IRP     ; SET BANK 0 (0x0C - 0x7F)
...
;;;   ELSE
;;    BSF     STATUS, IRP     ; BANK 1 (0x8C - 0xFF)
;;    MOVLW   0xC             ; SET THE WRITE POINTER
;;    MOVWF   FSR
;;    MOVFW   0xC             ; LOAD THE PATTERN INTO THE WORKING REGISTER
;;L3  MOVWF   INDF            ; MOVE THE PATTERN INTO THE ADDRESS POINTED TO BY FSR
;;    INCF    FSR,    1       ; INC THE POINTER TO NEXT ADDRESS
;;    BTFSS   FSR,    7       ; BIT TEST FSR BIT 7
;;    GOTO    L3              ; if(!FSR & 0b1000_0000) JMP label: L2
;;;   ELSE
;;    MOVLW   0xFF            ; XOR the pattern
;;    XORWF   0xC,    1
;;    GOTO    L0              ; start over at 0xC
;;    END
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
